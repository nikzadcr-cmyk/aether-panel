var ke=(e,t,r)=>(n,s)=>{let a=-1;return o(0);async function o(i){if(i<=a)throw new Error("next() called multiple times");a=i;let c,l=!1,d;if(e[i]?(d=e[i][0][0],n.req.routeIndex=i):d=i===e.length&&s||void 0,d)try{c=await d(n,()=>o(i+1))}catch(u){if(u instanceof Error&&t)n.error=u,c=await t(u,n),l=!0;else throw u}else n.finalized===!1&&r&&(c=await r(n));return c&&(n.finalized===!1||l)&&(n.res=c),n}};var Qe=Symbol();var Xe=(e,t)=>new Response(e,{headers:{"Content-Type":t.replace(/^[^;]+/,n=>n.toLowerCase())}}).formData();var ce=e=>"headers"in e,et=async(e,t=Object.create(null))=>{let{all:r=!1,dot:n=!1}=t,o=(ce(e)?e.headers:e.raw.headers).get("Content-Type")?.split(";")[0].trim().toLowerCase();return o==="multipart/form-data"||o==="application/x-www-form-urlencoded"?yr(e,{all:r,dot:n}):{}};async function yr(e,t){if(!ce(e)&&e.bodyCache.formData)return Ze(await e.bodyCache.formData,t);let r=ce(e)?e.headers:e.raw.headers,n=await e.arrayBuffer(),s=Xe(n,r.get("Content-Type")||"");ce(e)||(e.bodyCache.formData=s);let a=await s;return a?Ze(a,t):{}}function Ze(e,t){let r=Object.create(null);return e.forEach((n,s)=>{t.all||s.endsWith("[]")?xr(r,s,n):r[s]=n}),t.dot&&Object.entries(r).forEach(([n,s])=>{n.includes(".")&&(wr(r,n,s),delete r[n])}),r}var xr=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},wr=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let n=e,s=t.split(".");s.forEach((a,o)=>{o===s.length-1?n[a]=r:((!n[a]||typeof n[a]!="object"||Array.isArray(n[a])||n[a]instanceof File)&&(n[a]=Object.create(null)),n=n[a])})};var Ae=e=>{let t=e.split("/");return t[0]===""&&t.shift(),t},tt=e=>{let{groups:t,path:r}=vr(e),n=Ae(r);return Er(n,t)},vr=e=>{let t=[];return e=e.replace(/\{[^}]+\}/g,(r,n)=>{let s=`@${n}`;return t.push([s,r]),s}),{groups:t,path:e}},Er=(e,t)=>{for(let r=t.length-1;r>=0;r--){let[n]=t[r];for(let s=e.length-1;s>=0;s--)if(e[s].includes(n)){e[s]=e[s].replace(n,t[r][1]);break}}return e},le={},rt=(e,t)=>{if(e==="*")return"*";let r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){let n=`${e}#${t}`;return le[n]||(r[2]?le[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:le[n]=[e,r[1],!0]),le[n]}return null},nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},kr=e=>nt(e,decodeURI),Se=e=>{let t=e.url,r=t.indexOf("/",t.indexOf(":")+4),n=r;for(;n<t.length;n++){let s=t.charCodeAt(n);if(s===37){let a=t.indexOf("?",n),o=t.indexOf("#",n),i=a===-1?o===-1?void 0:o:o===-1?a:Math.min(a,o),c=t.slice(r,i);return kr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(s===63||s===35)break}return t.slice(r,n)};var st=e=>{let t=Se(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},N=(e,t,...r)=>(r.length&&(t=N(t,...r)),`${e?.[0]==="/"?"":"/"}${e}${t==="/"?"":`${e?.at(-1)==="/"?"":"/"}${t?.[0]==="/"?t.slice(1):t}`}`),de=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;let t=e.split("/"),r=[],n="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))n+="/"+s;else if(/\:/.test(s))if(s.charCodeAt(s.length-1)===63){r.length===0&&n===""?r.push("/"):r.push(n);let a=s.slice(0,-1);n+="/"+a,r.push(n)}else n+="/"+s}),r.filter((s,a,o)=>o.indexOf(s)===a)},ue=e=>e.indexOf("%")!==-1?nt(e,_r):e,_e=e=>(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),ue(e)),at=(e,t,r)=>{let n;if(!r&&t&&t.indexOf("%")===-1&&t.indexOf("+")===-1){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){let i=e.charCodeAt(o+t.length+1);if(i===61){let c=o+t.length+2,l=e.indexOf("&",c);return _e(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(n=/[%+]/.test(e),!n)return}let s=Object.create(null);n??=/[%+]/.test(e);let a=e.indexOf("?",8);for(;a!==-1;){let o=e.indexOf("&",a+1),i=e.indexOf("=",a);i>o&&o!==-1&&(i=-1);let c=e.slice(a+1,i===-1?o===-1?void 0:o:i);if(n&&(c=_e(c)),a=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),n&&(l=_e(l))),r?(s[c]&&Array.isArray(s[c])||(s[c]=[]),s[c].push(l)):s[c]??=l}return t?s[t]:s},ot=at,it=(e,t)=>at(e,t,!0),_r=decodeURIComponent;var ct=class{raw;#t;#e;routeIndex=0;path;bodyCache={};constructor(e,t="/",r=[[]]){this.raw=e,this.path=t,this.#e=r}param(e){return e?this.#r(e):this.#a()}#r(e){let t=this.#e[0][this.routeIndex][1][e],r=this.#n(t);return r&&ue(r)}#a(){let e={},t=Object.keys(this.#e[0][this.routeIndex][1]);for(let r of t){let n=this.#n(this.#e[0][this.routeIndex][1][r]);n!==void 0&&(e[r]=ue(n))}return e}#n(e){return this.#e[1]?this.#e[1][e]:e}query(e){return ot(this.url,e)}queries(e){return it(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;let t=Object.create(null);return this.raw.headers.forEach((r,n)=>{t[n]=r}),t}async parseBody(e){return et(this,e)}#s=e=>{let{bodyCache:t,raw:r}=this,n=t[e];if(n)return n;for(let s in t)return t[s].then(a=>(s==="json"&&(a=JSON.stringify(a)),new Response(a)[e]()));return t[e]=r[e]()};json(){return this.#s("text").then(e=>JSON.parse(e))}text(){return this.#s("text")}arrayBuffer(){return this.#s("arrayBuffer")}bytes(){return this.#s("arrayBuffer").then(e=>new Uint8Array(e))}blob(){return this.#s("blob")}formData(){return this.#s("formData")}addValidatedData(e,t){(this.#t??={})[e]=t}valid(e){return this.#t?.[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Qe](){return this.#e}get matchedRoutes(){return this.#e[0].map(([[,e]])=>e)}get routePath(){return this.#e[0].map(([[,e]])=>e)[this.routeIndex].path}};var lt={Stringify:1,BeforeStream:2,Stream:3},Ar=(e,t)=>{let r=new String(e);return r.isEscaped=!0,r.callbacks=t,r};var Re=async(e,t,r,n,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));let a=e.callbacks;if(!a?.length)return Promise.resolve(e);s?s[0]+=e:s=[e];let o=Promise.all(a.map(i=>i({phase:t,buffer:s,context:n}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Re(c,t,!1,n,s))).then(()=>s[0]));return r?Ar(await o,a):o};var Sr="text/plain; charset=UTF-8",Te=(e,t)=>({"Content-Type":e,...t}),ee=(e,t)=>new Response(e,t),Ue=class{#t;#e;env={};#r;finalized=!1;error;#a;#n;#s;#d;#c;#l;#i;#u;#p;constructor(e,t){this.#t=e,t&&(this.#n=t.executionCtx,this.env=t.env,this.#l=t.notFoundHandler,this.#p=t.path,this.#u=t.matchResult)}get req(){return this.#e??=new ct(this.#t,this.#p,this.#u),this.#e}get event(){if(this.#n&&"respondWith"in this.#n)return this.#n;throw Error("This context has no FetchEvent")}get executionCtx(){if(this.#n)return this.#n;throw Error("This context has no ExecutionContext")}get res(){return this.#s||=ee(null,{headers:this.#i??=new Headers})}set res(e){if(this.#s&&e){e=ee(e.body,e);for(let[t,r]of this.#s.headers.entries())if(t!=="content-type")if(t==="set-cookie"){let n=this.#s.headers.getSetCookie();e.headers.delete("set-cookie");for(let s of n)e.headers.append("set-cookie",s)}else e.headers.set(t,r)}this.#s=e,this.finalized=!0}render=(...e)=>(this.#c??=t=>this.html(t),this.#c(...e));setLayout=e=>this.#d=e;getLayout=()=>this.#d;setRenderer=e=>{this.#c=e};header=(e,t,r)=>{this.finalized&&(this.#s=ee(this.#s.body,this.#s));let n=this.#s?this.#s.headers:this.#i??=new Headers;t===void 0?n.delete(e):r?.append?n.append(e,t):n.set(e,t)};status=e=>{this.#a=e};set=(e,t)=>{this.#r??=new Map,this.#r.set(e,t)};get=e=>this.#r?this.#r.get(e):void 0;get var(){return this.#r?Object.fromEntries(this.#r):{}}#o(e,t,r){let n=this.#s?new Headers(this.#s.headers):this.#i;if(typeof t=="object"&&t.headers){n??=new Headers;for(let[a,o]of new Headers(t.headers))a==="set-cookie"?n.append(a,o):n.set(a,o)}if(r){if(!n){let a=0;for(let o in r)if(++a>1||typeof r[o]!="string"){n=new Headers;break}}if(n)for(let a in r){let o=r[a];if(typeof o=="string")n.set(a,o);else{n.delete(a);for(let i of o)n.append(a,i)}}}let s=typeof t=="number"?t:t?.status??this.#a;return ee(e,{status:s,headers:n??r})}newResponse=(...e)=>this.#o(...e);body=(e,t,r)=>this.#o(e,t,r);text=(e,t,r)=>!this.#i&&!this.#a&&!t&&!r&&!this.finalized?new Response(e):this.#o(e,t,Te(Sr,r));json=(e,t,r)=>this.#o(JSON.stringify(e),t,Te("application/json",r));html=(e,t,r)=>{let n=s=>this.#o(s,t,Te("text/html; charset=UTF-8",r));return typeof e=="object"?Re(e,lt.Stringify,!1,{}).then(n):n(e)};redirect=(e,t)=>{let r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)};notFound=()=>(this.#l??=()=>ee(),this.#l(this))};var S="ALL",dt="all",ut=["get","post","put","delete","options","patch","query"],pe="Can not add a route since the matcher is already built.",he=class extends Error{};var pt="__COMPOSED_HANDLER";var Rr=e=>e.text("404 Not Found",404),ht=(e,t)=>{if("getResponse"in e){let r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},mt=class ft{get;post;put;delete;options;patch;query;all;on;use;router;getPath;_basePath="/";#t="/";routes=[];constructor(t={}){[...ut,dt].forEach(a=>{this[a]=(o,...i)=>(typeof o=="string"?this.#t=o:this.#a(a,this.#t,o),i.forEach(c=>{this.#a(a,this.#t,c)}),this)}),this.on=(a,o,...i)=>{for(let c of[o].flat()){this.#t=c;for(let l of[a].flat())i.map(d=>{this.#a(l.toUpperCase(),this.#t,d)})}return this},this.use=(a,...o)=>(typeof a=="string"?this.#t=a:(this.#t="*",o.unshift(a)),o.forEach(i=>{this.#a(S,this.#t,i)}),this);let{strict:n,...s}=t;Object.assign(this,s),this.getPath=n??!0?t.getPath??Se:st}#e(){let t=new ft({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,t.#r=this.#r,t.routes=this.routes,t}#r=Rr;errorHandler=ht;route(t,r){let n=this.basePath(t);return r.routes.map(s=>{let a;r.errorHandler===ht?a=s.handler:(a=async(o,i)=>(await ke([],r.errorHandler)(o,()=>s.handler(o,i))).res,a[pt]=s.handler),n.#a(s.method,s.path,a,s.basePath)}),this}basePath(t){let r=this.#e();return r._basePath=N(this._basePath,t),r}onError=t=>(this.errorHandler=t,this);notFound=t=>(this.#r=t,this);mount(t,r,n){let s,a;n&&(typeof n=="function"?a=n:(a=n.optionHandler,n.replaceRequest===!1?s=c=>c:s=n.replaceRequest));let o=a?c=>{let l=a(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};s||=(()=>{let c=N(this._basePath,t),l=c==="/"?0:c.length;return d=>{let u=new URL(d.url);return u.pathname=this.getPath(d).slice(l)||"/",new Request(u,d)}})();let i=async(c,l)=>{let d=await r(s(c.req.raw),...o(c));if(d)return d;await l()};return this.#a(S,N(t,"*"),i),this}#a(t,r,n,s){t=t.toUpperCase(),r=N(this._basePath,r);let a={basePath:s!==void 0?N(this._basePath,s):this._basePath,path:r,method:t,handler:n};this.router.add(t,r,[n,a]),this.routes.push(a)}#n(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t}#s(t,r,n,s){if(s==="HEAD")return(async()=>new Response(null,await this.#s(t,r,n,"GET")))();let a=this.getPath(t,{env:n}),o=this.router.match(s,a),i=new Ue(t,{path:a,matchResult:o,env:n,executionCtx:r,notFoundHandler:this.#r});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await this.#r(i)})}catch(d){return this.#n(d,i)}return l instanceof Promise?l.then(d=>d||(i.finalized?i.res:this.#r(i))).catch(d=>this.#n(d,i)):l??this.#r(i)}let c=ke(o[0],this.errorHandler,this.#r);return(async()=>{try{let l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return this.#n(l,i)}})()}fetch=(t,...r)=>this.#s(t,r[1],r[0],t.method);request=(t,r,n,s)=>t instanceof Request?this.fetch(r?new Request(t,r):t,n,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${N("/",t)}`,r),n,s));fire=()=>{addEventListener("fetch",t=>{t.respondWith(this.#s(t.request,t,void 0,t.request.method))})}};var me=[];function Ce(e,t){let r=this.buildAllMatchers(),n=(s,a)=>{let o=r[s]||r[S],i=o[2][a];if(i)return i;let c=a.match(o[0]);if(!c)return[[],me];let l=c.indexOf("",1);return[o[1][l],c]};return this.match=n,n(e,t)}var fe="[^/]+",G=".*",V="(?:|/.*)",$=Symbol(),gt=new Set(".\\+*[^]$()");function Tr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1?1:e===G||e===V?t===V?-1:1:t===G||t===V?-1:e===fe?1:t===fe?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var bt=class Pe{#t;#e;#r=Object.create(null);insert(t,r,n,s,a){let o=this;for(let i=0,c=t.length;i<c;i++){let l=t[i],d=l.length===1?l==="*"?i===c-1?["","",G]:["","",fe]:null:l==="/*"?["","",V]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/),u;if(d){let h=d[1],p=d[2]||fe;if(h&&d[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))||p.length===1&&gt.has(p)))throw $;if(u=o.#r[p],!u){if(p!==G&&p!==V){for(let f in o.#r)if((p.length>1||f.length>1)&&f!==G&&f!==V)throw $}u=o.#r[p]=new Pe}h!==""&&(u.#e??=s.varIndex++,n.push([h,u.#e]))}else if(u=o.#r[l],!u){for(let h in o.#r)if(h.length>1&&h!==G&&h!==V)throw $;u=o.#r[l]=new Pe}o=u}if(o.#t!==void 0)throw $;o.#t=a?-1:r}buildRegExpStr(){let r=Object.keys(this.#r).sort(Tr).map(n=>{let s=this.#r[n],a=s.buildRegExpStr();return a===""?"":(typeof s.#e=="number"?`(${n})@${s.#e}`:gt.has(n)?`\\${n}`:n)+a}).filter(Boolean);return typeof this.#t=="number"&&this.#t!==-1&&r.unshift(`#${this.#t}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}};var Le=class{#t={varIndex:0};#e=new bt;#r=0;paths=Object.create(null);insert(e,t){if(t){this.#e.insert(e.split(""),0,[],this.#t,!0);return}let r=[],n=[],s=e;for(let o=0;;){let i=!1;if(s=s.replace(/\{[^}]+\}/g,c=>{let l=`@\\${o}`;return n[o]=[l,c],o++,i=!0,l}),!i)break}let a=s.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){let[i]=n[o];for(let c=a.length-1;c>=0;c--)if(a[c].indexOf(i)!==-1){a[c]=a[c].replace(i,n[o][1]);break}}this.#e.insert(a,this.#r,r,this.#t,!1),this.paths[e]=[this.#r++,r]}buildRegExp(){let e=this.#e.buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0,r=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,a,o)=>a!==void 0?(r[++t]=Number(a),"$()"):(o!==void 0&&(n[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,n]}};var yt=Object.create(null);function xt(e){return yt[e]??=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`)}function Ur(){yt=Object.create(null)}function ge(e,t){if(e){for(let r of Object.keys(e).sort((n,s)=>s.length-n.length))if(xt(r).test(t))return[...e[r]]}}var be=class{name="RegExpRouter";#t;#e;#r;constructor(){this.#t={[S]:Object.create(null)},this.#e={[S]:Object.create(null)},this.#r={[S]:new Le}}#a(e,t){try{this.#r[e].insert(t,!/\*|\/:/.test(t))}catch(r){throw r===$?new he(t):r}}add(e,t,r){let n=this.#t,s=this.#e;if(!n||!s)throw new Error(pe);n[e]||(this.#r[e]=new Le,[n,s].forEach(i=>{i[e]=Object.create(null),Object.keys(i[S]).forEach(c=>{i[e][c]=[...i[S][c]],this.#a(e,c)})})),t==="/*"&&(t="*");let a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){let i=xt(t);Object.keys(n).forEach(c=>{(e===S||e===c)&&!n[c][t]&&(this.#a(c,t),n[c][t]=ge(n[c],t)||ge(n[S],t)||[])}),Object.keys(n).forEach(c=>{(e===S||e===c)&&Object.keys(n[c]).forEach(l=>{i.test(l)&&n[c][l].push([r,a])})}),Object.keys(s).forEach(c=>{(e===S||e===c)&&Object.keys(s[c]).forEach(l=>i.test(l)&&s[c][l].push([r,a]))});return}let o=de(t)||[t];for(let i=0,c=o.length;i<c;i++){let l=o[i];Object.keys(s).forEach(d=>{(e===S||e===d)&&(s[d][l]||(this.#a(d,l),s[d][l]=[...ge(n[d],l)||ge(n[S],l)||[]]),s[d][l].push([r,a-c+i+1]))})}}match=Ce;buildAllMatchers(){let e=Object.create(null);return Object.keys(this.#e).concat(Object.keys(this.#t)).forEach(t=>{e[t]||=this.#n(t)}),this.#t=this.#e=this.#r=void 0,Ur(),e}#n(e){let t=this.#t[e],r=this.#e[e],n=this.#r[e],s=Object.create(null),a=[];[t,r].forEach(d=>{for(let u in d){let h=d[u],p=n.paths[u];if(!p){s[u]=[h.map(([E])=>[E,Object.create(null)]),me];continue}let f=p[1];a[p[0]]=h.map(([E,w])=>{let x=Object.create(null);for(w-=1;w>=0;w--){let[g,v]=f[w];x[g]=v}return[E,x]})}});let[o,i,c]=n.buildRegExp();for(let d=0,u=a.length;d<u;d++)for(let h=0,p=a[d].length;h<p;h++){let f=a[d][h]?.[1];if(!f)continue;let E=Object.keys(f);for(let w=0,x=E.length;w<x;w++)f[E[w]]=c[f[E[w]]]}let l=[];for(let d in i)l[d]=a[i[d]];return[o,l,s]}};var Be=class{name="SmartRouter";#t=[];#e=[];constructor(e){this.#t=e.routers}add(e,t,r){if(!this.#e)throw new Error(pe);this.#e.push([e,t,r])}match(e,t){if(!this.#e)throw new Error("Fatal error");let r=this.#t,n=this.#e,s=r.length,a=0,o;for(;a<s;a++){let i=r[a];try{for(let c=0,l=n.length;c<l;c++)i.add(...n[c]);o=i.match(e,t)}catch(c){if(c instanceof he)continue;throw c}this.match=i.match.bind(i),this.#t=[i],this.#e=void 0;break}if(a===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(this.#e||this.#t.length!==1)throw new Error("No active router has been determined yet.");return this.#t[0]}};var je=Object.create(null),Cr=0,wt=class vt{#t=[];#e=Object.create(null);#r=[];#a;#n=je;insert(t,r,n){let s=this,a=tt(r),o=new Set,i=0;for(let c of a){let l=a[++i],d=rt(c,l)||(l===void 0&&c&&c.indexOf("*")===c.length-1?c:null),u=Array.isArray(d),h=u?d[0]:d||c,p=s.#e[h]||=new vt;d&&!p.#a&&(p.#a=d,s.#r.push(p)),s=p,u&&o.add(d[1])}s.#t.push({[t]:{handler:n,possibleKeys:[...o],score:++Cr}})}#s(t,r,n,s,a){for(let o=0,i=r.#t.length;o<i;o++){let c=r.#t[o],l=c[n]||c[S];if(l){l.params=Object.create(null),t.push(l);for(let d=0,u=l.possibleKeys.length;d<u;d++){let h=l.possibleKeys[d];l.params[h]=a?.[h]&&!d?a[h]:s[h]??a?.[h]}}}}search(t,r){let n=[];this.#n=je;let a=[this],o=Ae(r),i=[],c=o.length,l=null;for(let d=0;d<c;d++){let u=o[d],h=d===c-1,p=[];for(let E=0,w=a.length;E<w;E++){let x=a[E],g=x.#e[u];g&&(g.#n=x.#n,h?(g.#e["*"]&&this.#s(n,g.#e["*"],t,x.#n),this.#s(n,g,t,x.#n)):p.push(g));for(let v of x.#r){let b=v.#a,k=x.#n===je?{}:{...x.#n};if(typeof b=="string"){(b==="*"||u.startsWith(b.slice(0,-1)))&&(this.#s(n,v,t,x.#n),b==="*"&&(v.#n=k,p.push(v)));continue}let[,m,y]=b;if(!(!u&&y===!0)){if(y!==!0){if(!l){l=[];let W=r[0]==="/"?1:0;for(let H=0;H<c;H++)l[H]=W,W+=o[H].length+1}let _=r.slice(l[d]),T=y.exec(_);if(T){k[m]=T[0],this.#s(n,v,t,x.#n,k),T[0].length===_.length&&v.#e["*"]&&this.#s(n,v.#e["*"],t,x.#n,k);for(let W in v.#e){v.#n=k;let H=T[0].match(/\//g)?.length??0;(i[H]||=[]).push(v);break}continue}}(y===!0||y.test(u))&&(k[m]=u,h?(this.#s(n,v,t,k,x.#n),v.#e["*"]&&this.#s(n,v.#e["*"],t,k,x.#n)):(v.#n=k,p.push(v)))}}}let f=i.shift();a=f?p.concat(f):p}return n[1]&&n.sort((d,u)=>d.score-u.score),[n.map(({handler:d,params:u})=>[d,u])]}};var Oe=class{name="TrieRouter";#t=new wt;add(e,t,r){for(let n of de(t)||[t])this.#t.insert(e,n,r)}match(e,t){return this.#t.search(e,t)}};var B=class extends mt{constructor(e={}){super(e),this.router=e.router??new Be({routers:[new be,new Oe]})}};var Et=e=>{let t={origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH","QUERY"],allowHeaders:[],exposeHeaders:[],...e},r=t.exposeHeaders?.length?t.exposeHeaders.join(","):void 0,n=t.allowHeaders?.length?t.allowHeaders.join(","):void 0,s=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(t.origin),a=(o=>{if(typeof o=="function")return async(i,c)=>(await o(i,c)).join(",");if(Array.isArray(o)){let i=o.join(",");return()=>i}else return()=>""})(t.allowMethods);return async function(i,c){function l(u,h){i.res.headers.set(u,h)}let d=await s(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),t.credentials&&l("Access-Control-Allow-Credentials","true"),r&&l("Access-Control-Expose-Headers",r),i.req.method==="OPTIONS"){t.origin!=="*"&&i.res.headers.append("Vary","Origin"),t.maxAge!=null&&l("Access-Control-Max-Age",t.maxAge.toString());let u=await a(i.req.header("origin")||"",i);u&&l("Access-Control-Allow-Methods",u);let h=n;if(!h){let p=i.req.header("Access-Control-Request-Headers");p&&(h=p.split(",").map(f=>f.trim()).join(","))}return h&&(l("Access-Control-Allow-Headers",h),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await c(),t.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Pr(){let{process:e,Deno:t}=globalThis;return!(typeof t?.noColor=="boolean"?t.noColor:e!==void 0?"NO_COLOR"in e?.env:!1)}async function kt(){let{navigator:e}=globalThis,t="cloudflare:workers";return!(e!==void 0&&e.userAgent==="Cloudflare-Workers"?await(async()=>{try{return"NO_COLOR"in((await import(t)).env??{})}catch{return!1}})():!Pr())}var Lr=e=>{let[t,r]=[",","."];return e.map(s=>s.replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1"+t)).join(r)},Br=e=>{let t=Date.now()-e;return Lr([t<1e3?t+"ms":Math.round(t/1e3)+"s"])},jr=async e=>{if(await kt())switch(e/100|0){case 5:return`\x1B[31m${e}\x1B[0m`;case 4:return`\x1B[33m${e}\x1B[0m`;case 3:return`\x1B[36m${e}\x1B[0m`;case 2:return`\x1B[32m${e}\x1B[0m`}return`${e}`};async function _t(e,t,r,n,s=0,a){let o=t==="<--"?`${t} ${r} ${n}`:`${t} ${r} ${n} ${await jr(s)} ${a}`;e(o)}var At=(e=console.log)=>async function(r,n){let{method:s,url:a}=r.req,o=a.slice(a.indexOf("/",8));await _t(e,"<--",s,o);let i=Date.now();await n(),await _t(e,"-->",s,o,r.res.status,Br(i))};function St(e){return e instanceof Uint8Array?e:new Uint8Array(e)}function Ie(e){return/^(\d{1,3}\.){3}\d{1,3}$/.test(e)}function De(){if(typeof crypto.randomUUID=="function")return crypto.randomUUID();let e=new Uint8Array(16);crypto.getRandomValues(e),e[6]=e[6]&15|64,e[8]=e[8]&63|128;let t=Array.from(e).map(r=>r.toString(16).padStart(2,"0"));return`${t.slice(0,4).join("")}-${t.slice(4,6).join("")}-${t.slice(6,8).join("")}-${t.slice(8,10).join("")}-${t.slice(10).join("")}`}function C(){return Math.floor(Date.now()/1e3)}function Rt(e){if(!e||e==="unknown")return e;if(e.includes(":")){let r=e.split(":");return r.length>=4?r.slice(0,4).join(":")+"::/64":e}let t=e.split(".");return t.length===4?t.slice(0,3).join(".")+".0/24":e}function Tt(e,t){let r=e[t];t+=1;let n="",s;if(r===1)s="ipv4",n=`${e[t]}.${e[t+1]}.${e[t+2]}.${e[t+3]}`,t+=4;else if(r===3){s="domain";let o=e[t];t+=1,n=new TextDecoder().decode(e.subarray(t,t+o)),t+=o}else if(r===4){s="ipv6";let o=[];for(let i=0;i<16;i+=2)o.push((e[t+i]<<8|e[t+i+1]).toString(16));n=o.join(":"),t+=16}else throw new Error(`unsupported ATYP 0x${r.toString(16)}`);let a=e[t]<<8|e[t+1];return t+=2,{addr:{host:n,port:a,type:s},next:t}}function Or(e){if(e.byteLength<20||e[0]!==0)throw new Error("invalid vless header");let t=e.subarray(1,17),r=Array.from(t).map(l=>l.toString(16).padStart(2,"0")).join(""),n=`${r.slice(0,8)}-${r.slice(8,12)}-${r.slice(12,16)}-${r.slice(16,20)}-${r.slice(20,32)}`,s=17,a=e[s];s+=1+a;let{addr:o,next:i}=Tt(e,s),c=e.subarray(i);return{protocol:"vless",uuid:n,target:o,payload:c.slice(),raw:e.slice()}}function Ir(e){if(e.byteLength<60)throw new Error("trojan header too short");let t;try{if(t=new TextDecoder("ascii").decode(e.subarray(0,56)).toLowerCase(),!/^[0-9a-f]{56}$/.test(t))throw new Error("bad hex")}catch{throw new Error("invalid trojan password header")}let r=56;e[r]===13&&e[r+1]===10&&(r+=2);let n=e[r];if(r+=1,n!==1)throw new Error(`trojan cmd ${n} not supported`);let{addr:s,next:a}=Tt(e,r);r=a,e[r]===13&&e[r+1]===10&&(r+=2);let o=e.subarray(r);return{protocol:"trojan",passwordHash:t,target:s,payload:o.slice(),raw:e.slice()}}function Dr(e){if(e.byteLength<40)throw new Error("vmess header too short");let t=1+16+16;t+=1,t+=1,t+=1;let r=e[t]<<8|e[t+1];t+=2;let n=e[t];t+=1;let s="",a;if(n===1)a="ipv4",s=`${e[t]}.${e[t+1]}.${e[t+2]}.${e[t+3]}`,t+=4;else if(n===3){a="domain";let d=e[t];t+=1,s=new TextDecoder().decode(e.subarray(t,t+d)),t+=d}else if(n===4){a="ipv6";let d=[];for(let u=0;u<16;u+=2)d.push((e[t+u]<<8|e[t+u+1]).toString(16));s=d.join(":"),t+=16}else throw new Error(`vmess: unsupported ATYP 0x${n.toString(16)}`);let o=e.subarray(t,t+16),i=Array.from(o).map(d=>d.toString(16).padStart(2,"0")).join(""),c=`${i.slice(0,8)}-${i.slice(8,12)}-${i.slice(12,16)}-${i.slice(16,20)}-${i.slice(20,32)}`;t+=16;let l=e.subarray(t);return{protocol:"vmess",uuid:c,target:{host:s,port:r,type:a},payload:l.slice(),raw:e.slice()}}function Ut(e,t){let r=St(e);if(t.has("trojan")&&r.byteLength>=58){let n=new TextDecoder("ascii").decode(r.subarray(0,56));if(/^[0-9a-fA-F]{56}$/.test(n)&&r[56]===13&&r[57]===10)return Ir(r)}if(t.has("vless")&&r.byteLength>=20&&r[0]===0)return Or(r);if(t.has("vmess"))return Dr(r);throw new Error("no protocol matched first frame")}function Ct(){return new Uint8Array([0,0])}import{connect as xe}from"cloudflare:sockets";var Pt=8e3,Mr=8e3;async function Me(e,t,r){let n=xe({hostname:e,port:t});if(await Promise.race([n.opened,new Promise((s,a)=>setTimeout(()=>a(new Error("connect timeout")),Pt))]),r&&r.byteLength>0){let s=n.writable.getWriter();await s.write(r),s.releaseLock()}return te(n)}async function Lt(e,t,r,n){let s=Bt(e);return s.startsWith("http://")||s.startsWith("https://")?Nr(s,t,r,n):s.startsWith("socks4://")?Hr(s,t,r,n):qr(s,t,r,n)}async function qr(e,t,r,n){let{user:s,pass:a,host:o,port:i}=qe(e),c=xe({hostname:o,port:i});await Promise.race([c.opened,ye("socks5 connect")]);let l=c.writable.getWriter(),d=c.readable.getReader();try{let u=s?new Uint8Array([5,2,0,2]):new Uint8Array([5,1,0]);await l.write(u);let h=await J(d,2);if(h[0]!==5)throw new Error("bad socks5 greeting");if(h[1]===2){if(!s)throw new Error("socks5 requires auth");let w=new TextEncoder().encode(s),x=new TextEncoder().encode(a),g=new Uint8Array(3+w.byteLength+x.byteLength);if(g[0]=1,g[1]=w.byteLength,g.set(w,2),g[2+w.byteLength]=x.byteLength,g.set(x,3+w.byteLength),await l.write(g),(await J(d,2))[1]!==0)throw new Error("socks5 auth failed")}let p=$r(t,r),f=new Uint8Array(3+p.byteLength);f[0]=5,f[1]=1,f[2]=0,f.set(p,3),await l.write(f);let E=await Fr(d);if(E!==0)throw new Error(`socks5 reply 0x${E.toString(16)}`);n&&n.byteLength>0&&await l.write(n)}finally{l.releaseLock(),d.releaseLock()}return te(c)}async function Hr(e,t,r,n){let{user:s,host:a,port:o}=qe(e),i=xe({hostname:a,port:o});await Promise.race([i.opened,ye("socks4 connect")]);let c=i.writable.getWriter(),l=i.readable.getReader();try{let d=!Ie(t),u;if(d){let p=new TextEncoder().encode(t);u=new Uint8Array(9+p.byteLength+1),u[0]=4,u[1]=1,u[2]=r>>8&255,u[3]=r&255,u[4]=0,u[5]=0,u[6]=0,u[7]=1,u[8]=0,u.set(p,9),u[9+p.byteLength]=0}else{let p=t.split(".").map(Number);u=new Uint8Array(9),u[0]=4,u[1]=1,u[2]=r>>8&255,u[3]=r&255,u[4]=p[0],u[5]=p[1],u[6]=p[2],u[7]=p[3],u[8]=0}if(s){let p=new TextEncoder().encode(s),f=new Uint8Array(u.byteLength+p.byteLength);f.set(p,0),f.set(u,p.byteLength),u=f}await c.write(u);let h=await J(l,8);if(h[0]!==0||h[1]!==90)throw new Error("socks4 rejected");n&&n.byteLength>0&&await c.write(n)}finally{c.releaseLock(),l.releaseLock()}return te(i)}async function Nr(e,t,r,n){let{user:s,pass:a,host:o,port:i}=qe(e),c=xe({hostname:o,port:i});await Promise.race([c.opened,ye("http proxy connect")]);let l=c.writable.getWriter(),d=c.readable.getReader();try{let u=[`CONNECT ${t}:${r} HTTP/1.1`,`Host: ${t}:${r}`,"Proxy-Connection: keep-alive"];if(s){let E=btoa(`${s}:${a??""}`);u.push(`Proxy-Authorization: Basic ${E}`)}u.push("","");let h=new TextEncoder().encode(u.join(`\r
`)),p=new Uint8Array(h.byteLength);p.set(h),await l.write(p);let f=new Uint8Array(new ArrayBuffer(0));for(;;){let{value:E,done:w}=await Promise.race([d.read(),ye("http proxy read")]);if(w)throw new Error("http proxy closed");let x=new Uint8Array(E.byteLength);x.set(E),f=jt(f,x);let g=Wr(f,new Uint8Array([13,10,13,10]));if(g>=0){let v=new TextDecoder().decode(f.subarray(0,g)),b=v.match(/HTTP\/\d\.\d (\d{3})/);if(!b||parseInt(b[1],10)!==200)throw new Error(`http proxy: ${v}`);let k=f.subarray(g+4);if(n&&n.byteLength>0){let m=new Uint8Array(n.byteLength);m.set(n),await l.write(m)}if(k.byteLength>0)return te(c,k);break}}}finally{l.releaseLock(),d.releaseLock()}return te(c)}function te(e,t){let r=!t||t.byteLength===0,n=e.readable,s=r?n:new ReadableStream({start(a){a.enqueue(t),n.pipeTo(new WritableStream({write(o){a.enqueue(o)},close(){a.close()},abort(o){a.error(o)}})).catch(()=>a.close())}});return{writable:e.writable,readable:s,closed:e.closed,close:()=>{try{e.close?.()}catch{}}}}function $r(e,t){if(Ie(e)){let s=e.split(".").map(Number),a=new Uint8Array(1+4+2);return a[0]=1,a[1]=s[0],a[2]=s[1],a[3]=s[2],a[4]=s[3],a[5]=t>>8&255,a[6]=t&255,a}if(e.includes(":")){let s=e.split(":"),a=new Uint8Array(1+16+2);a[0]=4;for(let o=0;o<8;o++){let i=parseInt(s[o]||"0",16);a[1+o*2]=i>>8&255,a[2+o*2]=i&255}return a[17]=t>>8&255,a[18]=t&255,a}let r=new TextEncoder().encode(e),n=new Uint8Array(1+1+r.byteLength+2);return n[0]=3,n[1]=r.byteLength,n.set(r,2),n[2+r.byteLength]=t>>8&255,n[3+r.byteLength]=t&255,n}async function Fr(e){let t=await J(e,4);if(t[0]!==5)throw new Error("bad socks5 reply");let r=0;for(t[3]===1?r=4:t[3]===3?r=(await J(e,1))[0]:t[3]===4&&(r=16),r+=2;r>0;){let n=await J(e,Math.min(r,1024));r-=n.byteLength}return t[1]}async function J(e,t){let r=[],n=0;for(;n<t;){let{value:a,done:o}=await Promise.race([e.read(),new Promise((i,c)=>setTimeout(()=>c(new Error("proxy read timeout")),Mr))]);if(o)throw new Error("proxy closed early");r.push(a),n+=a.byteLength}return jt(...r).subarray(0,t)}function Bt(e){if(e.includes("t.me/socks")||e.includes("tg://socks")){let t=e.match(/server=([^&]+)/)?.[1],r=e.match(/port=([^&]+)/)?.[1],n=e.match(/user=([^&]+)/)?.[1],s=e.match(/pass=([^&]+)/)?.[1];if(t&&r)return n&&s?`socks5://${n}:${s}@${t}:${r}`:`socks5://${t}:${r}`}return e}function qe(e){let r=Bt(e).match(/^(?:socks[45]|https?):\/\/(?:([^@/?#]+)@)?([^:/?#]+)(?::(\d+))?/i);if(!r)throw new Error("bad proxy uri");let n,s;if(r[1]){let[a,o]=r[1].split(":");n=a?decodeURIComponent(a):void 0,s=o?decodeURIComponent(o):void 0}return{user:n,pass:s,host:r[2],port:parseInt(r[3]||"1080",10)}}function jt(...e){let t=e.reduce((s,a)=>s+a.byteLength,0),r=new Uint8Array(t),n=0;for(let s of e)r.set(s,n),n+=s.byteLength;return r}function Wr(e,t){e:for(let r=0;r+t.byteLength<=e.byteLength;r++){for(let n=0;n<t.byteLength;n++)if(e[r+n]!==t[n])continue e;return r}return-1}function ye(e){return new Promise((t,r)=>setTimeout(()=>r(new Error(e)),Pt))}function Ot(e,t,r={}){let n=r.grainBytes??131072,s=r.grainSilentMs??2,a=r.maxQueueBytes??32*1024*1024,o=!1,i=!1,c=!1,l=0,d=[],u=0,h=null,p=null,f=[],E=new Promise(m=>f.push(m)),w=m=>{try{r.onUp?.(m)}catch{}},x=m=>{try{r.onDown?.(m)}catch{}},g=m=>{if(!o){o=!0,h&&clearTimeout(h);try{t.close?.()}catch{}try{e.readyState===1&&e.close()}catch{}if(m)try{r.onError?.(m)}catch{}try{r.onClose?.()}catch{}f.forEach(y=>y())}},v=async()=>{if(u===0)return;if(p){await p;return}let m=d.length===1?d[0]:Vr(d);d=[],u=0,l-=m.byteLength;let y=t.writable.getWriter();p=(async()=>{try{await y.write(m),w(m.byteLength)}catch(_){g(_)}finally{try{y.releaseLock()}catch{}p=null,u>0&&b()}})(),await p},b=()=>{h||(h=setTimeout(async()=>{h=null;try{await v()}catch(m){g(m)}},s))},k=async m=>{if(o||typeof m.data=="string")return;let y=m.data instanceof Uint8Array?m.data:new Uint8Array(m.data);if(l+=y.byteLength,l>a)return g(new Error("upstream queue overflow"));d.push(y),u+=y.byteLength,u>=n?(h&&(clearTimeout(h),h=null),v().catch(g)):b()};return e.addEventListener("message",k),e.addEventListener("close",()=>{i=!0,g()}),e.addEventListener("error",m=>g(m)),(async()=>{let m=t.readable.getReader();try{for(;;){let{value:y,done:_}=await m.read();if(_)break;if(y.byteLength!==0){if(e.readyState!==1)break;e.send(y),x(y.byteLength)}}}catch(y){g(y)}finally{c=!0;try{m.releaseLock()}catch{}g()}})(),t.closed.catch(g).finally(()=>{c=!0,i&&g()}),{closed:E}}function Vr(e){let t=e.reduce((s,a)=>s+a.byteLength,0),r=new Uint8Array(t),n=0;for(let s of e)r.set(s,n),n+=s.byteLength;return r}var we=new TextEncoder,ga=new TextDecoder;async function Y(e){let t=typeof e=="string"?we.encode(e):e,r=await crypto.subtle.digest("SHA-256",t);return re(new Uint8Array(r))}async function ne(e){let t=typeof e=="string"?we.encode(e):e;return re(zr(t))}function zr(e){let t=new Uint32Array([3238371032,914150663,812702999,4144912697,4290775857,1750603025,1694076839,3204075428]),r=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),n=(d,u)=>d>>>u|d<<32-u,s=e.length*8,a=new Uint8Array(e.length+1);a.set(e),a[e.length]=128;let o=(56-a.length%64+64)%64,i=new Uint8Array(a.length+o+8);i.set(a);let c=new DataView(i.buffer);c.setUint32(i.length-8,Math.floor(s/4294967296)),c.setUint32(i.length-4,s>>>0);for(let d=0;d<i.length;d+=64){let u=new Uint32Array(64);for(let b=0;b<16;b++)u[b]=c.getUint32(d+b*4);for(let b=16;b<64;b++){let k=n(u[b-15],7)^n(u[b-15],18)^u[b-15]>>>3,m=n(u[b-2],17)^n(u[b-2],19)^u[b-2]>>>10;u[b]=u[b-16]+k+u[b-7]+m|0}let[h,p,f,E,w,x,g,v]=t;for(let b=0;b<64;b++){let k=n(w,6)^n(w,11)^n(w,25),m=w&x^~w&g,y=v+k+m+r[b]+u[b]|0,_=n(h,2)^n(h,13)^n(h,22),T=h&p^h&f^p&f,W=_+T|0;v=g,g=x,x=w,w=E+y|0,E=f,f=p,p=h,h=y+W|0}t[0]=t[0]+h|0,t[1]=t[1]+p|0,t[2]=t[2]+f|0,t[3]=t[3]+E|0,t[4]=t[4]+w|0,t[5]=t[5]+x|0,t[6]=t[6]+g|0,t[7]=t[7]+v|0}let l=new Uint8Array(28);for(let d=0;d<7;d++)l[d*4]=t[d]>>>24&255,l[d*4+1]=t[d]>>>16&255,l[d*4+2]=t[d]>>>8&255,l[d*4+3]=t[d]&255;return l}function re(e){let t="";for(let r=0;r<e.byteLength;r++)t+=e[r].toString(16).padStart(2,"0");return t}function It(e){if(e.length%2!==0)throw new Error("bad hex length");let t=new Uint8Array(e.length/2);for(let r=0;r<t.length;r++)t[r]=parseInt(e.slice(r*2,r*2+2),16);return t}var Dt=1e5,Kr=32,Gr=16;async function se(e){let t=new Uint8Array(Gr);crypto.getRandomValues(t);let r=await Mt(e,t,Dt);return`pbkdf2$${Dt}$${re(t)}$${re(new Uint8Array(r))}`}async function He(e,t){if(!t)return!1;if(t.startsWith("pbkdf2$")){let[,r,n,s]=t.split("$"),a=parseInt(r,10),o=It(n),i=It(s),c=new Uint8Array(await Mt(e,o,a));return Jr(c,i)}return/^[0-9a-f]{64}$/i.test(t)?await Y(e)===t.toLowerCase():!1}async function Mt(e,t,r){let n=await crypto.subtle.importKey("raw",we.encode(e),{name:"PBKDF2",hash:"SHA-256"},!1,["deriveBits"]);return crypto.subtle.deriveBits({name:"PBKDF2",hash:"SHA-256",salt:t,iterations:r},n,Kr*8)}function Jr(e,t){if(e.byteLength!==t.byteLength)return!1;let r=0;for(let n=0;n<e.byteLength;n++)r|=e[n]^t[n];return r===0}function Ne(e=32){let t=new Uint8Array(e);return crypto.getRandomValues(t),re(t)}function Yr(e){let t=typeof e=="string"?we.encode(e):e,r="";for(let n=0;n<t.byteLength;n++)r+=String.fromCharCode(t[n]);return btoa(r).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function qt(){return Yr(Ne(20)).slice(0,32)}async function Ht(e,t,r=1){let n=Xr(e.replace(/\s+/g,"").toUpperCase()),s=Math.floor(Date.now()/3e4);for(let a=-r;a<=r;a++)if(await Qr(n,s+a)===t.padStart(6,"0"))return!0;return!1}function Nt(e,t,r){return`otpauth://totp/${encodeURIComponent(t)}:${encodeURIComponent(r)}?secret=${e}&issuer=${encodeURIComponent(t)}&digits=6&period=30`}async function Qr(e,t){let r=new ArrayBuffer(8),n=new DataView(r);n.setUint32(0,Math.floor(t/4294967296)),n.setUint32(4,t>>>0);let s=await crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-1"},!1,["sign"]),a=new Uint8Array(await crypto.subtle.sign("HMAC",s,new Uint8Array(r))),o=a[a.length-1]&15;return(((a[o]&127)<<24|(a[o+1]&255)<<16|(a[o+2]&255)<<8|a[o+3]&255)%1e6).toString().padStart(6,"0")}function Xr(e){let t="ABCDEFGHIJKLMNOPQRSTUVWXYZ234567",r=0,n=0,s=[];for(let a of e){let o=t.indexOf(a);o<0||(n=n<<5|o,r+=5,r>=8&&(r-=8,s.push(n>>>r&255)))}return new Uint8Array(s)}var Zr=new TextEncoder,en=new TextDecoder,ve=new Map,tn=5*60*1e3,rn=2048;async function $t(e,t="A",r="https://cloudflare-dns.com/dns-query"){let n=`${e}:${t}:${r}`,s=ve.get(n);if(s&&Date.now()<s.expires)return s.answers;try{let o={A:1,AAAA:28,CNAME:5}[t]??1,i=nn(e.endsWith(".")?e.slice(0,-1):e),c=new Uint8Array(12+i.byteLength+4),l=new DataView(c.buffer);l.setUint16(0,crypto.getRandomValues(new Uint16Array(1))[0]),l.setUint16(2,256),l.setUint16(4,1),c.set(i,12),l.setUint16(12+i.byteLength,o),l.setUint16(12+i.byteLength+2,1);let d=await fetch(r,{method:"POST",headers:{"content-type":"application/dns-message",accept:"application/dns-message"},body:c});if(!d.ok)return[];let u=new Uint8Array(await d.arrayBuffer()),h=sn(u);return ve.size>=rn&&ve.clear(),ve.set(n,{expires:Date.now()+tn,answers:h}),h}catch{return[]}}function nn(e){let t=e.split("."),r=[];for(let o of t){let i=Zr.encode(o);r.push(new Uint8Array([i.byteLength]),i)}r.push(new Uint8Array([0]));let n=r.reduce((o,i)=>o+i.byteLength,0),s=new Uint8Array(n),a=0;for(let o of r)s.set(o,a),a+=o.byteLength;return s}function $e(e,t){let r=[],n=t,s=!1,a=-1,o=128;for(;n<e.byteLength&&o-- >0;){let i=e[n];if(i===0){s||(a=n+1);break}if((i&192)===192){s||(a=n+2),n=(i&63)<<8|e[n+1],s=!0;continue}r.push(en.decode(e.subarray(n+1,n+1+i))),n+=i+1}return a===-1&&(a=n+1),{name:r.join("."),end:a}}function sn(e){let t=new DataView(e.buffer),r=t.getUint16(4),n=t.getUint16(6),s=12;for(let o=0;o<r;o++){let{end:i}=$e(e,s);s=i+4}let a=[];for(let o=0;o<n&&s<e.byteLength;o++){let{end:i}=$e(e,s);s=i;let c=t.getUint16(s);s+=2,s+=2;let l=t.getUint32(s);s+=4;let d=t.getUint16(s);s+=2;let u=s,h="";if(c===1&&d===4)h=`${e[s]}.${e[s+1]}.${e[s+2]}.${e[s+3]}`,a.push({type:"A",data:h,ttl:l});else if(c===28&&d===16){let p=[];for(let f=0;f<16;f+=2)p.push((e[s+f]<<8|e[s+f+1]).toString(16));h=p.join(":"),a.push({type:"AAAA",data:h,ttl:l})}else if(c===5){let{name:p}=$e(e,s);h=p,a.push({type:"CNAME",data:h,ttl:l})}s=u+d}return a}var Ft=new Set(["0.0.0.0","::","176.103.130.130","176.103.130.131"]);async function Wt(e,t){if(!e)return!1;let n=t.doh||"https://family.cloudflare-dns.com/dns-query";return t.ads&&!t.porn&&(n="https://dns.adguard-dns.com/dns-query"),t.malware&&(n="https://security.cloudflare-dns.com/dns-query"),!!((await $t(e,"A",n)).some(a=>Ft.has(a.data))||(t.porn||t.ads||t.malware)&&(await $t(e,"AAAA",n)).some(o=>Ft.has(o.data)))}async function Vt(e,t,r){let s=new URL(e.url).pathname.split("/").filter(Boolean),a=new Set(["vless","trojan"]),o;if(s.length>=1&&["vless","trojan","vmess"].includes(s[0])){let d=s[0];a=new Set([d]),o=s.slice(1).join("/")}if(e.headers.get("upgrade")?.toLowerCase()!=="websocket")return new Response("expected websocket",{status:426});let i=new WebSocketPair,[c,l]=[i[0],i[1]];return l.accept(),l.binaryType="arraybuffer",r.waitUntil((async()=>{try{await an(l,e,t,a,o)}catch(d){try{l.close(1011,"session error")}catch{}console.error("tunnel session error",d)}})()),new Response(null,{status:101,webSocket:c})}async function an(e,t,r,n,s){let a=await new Promise((m,y)=>{let _=setTimeout(()=>y(new Error("first-frame timeout")),15e3);e.addEventListener("message",T=>{if(clearTimeout(_),typeof T.data=="string")return y(new Error("text frame not expected"));m(T.data instanceof Uint8Array?T.data:new Uint8Array(T.data))},{once:!0}),e.addEventListener("close",()=>{clearTimeout(_),y(new Error("closed"))},{once:!0}),e.addEventListener("error",T=>{clearTimeout(_),y(T)},{once:!0})}),o=Ut(a,n),i=s||o.uuid||o.passwordHash||"",c;if(o.protocol==="trojan"?c=await r.DB.prepare("SELECT * FROM users WHERE uuid = ? OR trojan_hash = ? LIMIT 1").bind(i,o.passwordHash??i).first().then(m=>m??void 0):c=await r.DB.prepare("SELECT * FROM users WHERE uuid = ? OR username = ? COLLATE NOCASE LIMIT 1").bind(i,i).first().then(m=>m??void 0),!c){e.close(1008,"unauthorized");return}let l=(c.connection_type||"vless").toLowerCase(),d=l.includes("vless"),u=l.includes("trojan"),h=l.includes("vmess");if(o.protocol==="vless"&&!d){e.close(1008,"protocol disabled");return}if(o.protocol==="trojan"&&!u){e.close(1008,"protocol disabled");return}if(o.protocol==="vmess"&&!h){e.close(1008,"protocol disabled");return}if(o.protocol==="trojan"){let m=c.trojan_hash||await ne(c.uuid);if(o.passwordHash!==m){e.close(1008,"bad password");return}}else if(o.uuid&&o.uuid.toLowerCase()!==c.uuid.toLowerCase()){e.close(1008,"bad uuid");return}if(c.is_active!==1){e.close(1008,"disabled");return}if(c.limit_gb!=null&&(c.used_gb??0)>=c.limit_gb){e.close(1008,"quota");return}if(c.limit_req!=null&&(c.used_req??0)>=c.limit_req){e.close(1008,"req quota");return}if(c.expiry_days!=null){let m=typeof c.created_at=="number"?c.created_at:Date.parse(c.created_at)/1e3;if(Date.now()/1e3>m+c.expiry_days*86400){e.close(1008,"expired");return}}let p=t.headers.get("CF-Connecting-IP")||"unknown",f=Rt(p),E=t.headers.get("User-Agent")||"",w=r.USER_STATE.idFromName(c.username),x=r.USER_STATE.get(w),g=await x.fetch(new URL("http://do/connect?ipLimit="+(c.ip_limit??0),"http://do").toString(),{method:"POST",body:JSON.stringify({ip:p,subnet:f,ua:E})});if(!g.ok){let m=await g.json();e.close(1008,m.code||"limit");return}if(o.protocol==="vless"&&e.send(Ct()),o.target.type==="domain"&&(c.block_porn||c.block_ads||c.block_malware))try{if(await Wt(o.target.host,{porn:c.block_porn===1,ads:c.block_ads===1,malware:c.block_malware===1,doh:c.doh_url||void 0})){e.close(1008,"blocked");return}}catch{}let v;try{let m=await on(c,r);m?v=await Lt(m,o.target.host,o.target.port,o.payload):v=await Me(o.target.host,o.target.port,o.payload)}catch(m){try{let y=cn(r);if(y)v=await Me(y,o.target.port,o.payload);else throw m}catch{await x.fetch("http://do/disconnect",{method:"POST",body:JSON.stringify({subnet:f})}),e.close(1011,"upstream failed");return}}await r.DB.prepare("UPDATE users SET used_req = used_req + 1, last_active = ? WHERE username = ?").bind(Math.floor(Date.now()/1e3),c.username).run().catch(()=>{});let b={up:0,down:0},k=Date.now();Ot(e,v,{grainBytes:128*1024,onUp:m=>{b.up+=m,x.fetch("http://do/addBytes",{method:"POST",body:JSON.stringify({bytes:m})}).catch(()=>{})},onDown:m=>{b.down+=m,x.fetch("http://do/addBytes",{method:"POST",body:JSON.stringify({bytes:m})}).catch(()=>{})},onClose:()=>{x.fetch("http://do/disconnect",{method:"POST",body:JSON.stringify({subnet:f})}).catch(()=>{});let m=Math.floor(k/36e5)*3600,y=b.up+b.down;r.DB.prepare(`INSERT INTO traffic_hourly (hour_bucket, username, bytes_up, bytes_down, requests)
         VALUES (?, ?, ?, ?, 1)
         ON CONFLICT(hour_bucket, username) DO UPDATE SET
           bytes_up = bytes_up + excluded.bytes_up,
           bytes_down = bytes_down + excluded.bytes_down,
           requests = requests + 1`).bind(m,c.username,b.up,b.down).run().catch(()=>{});try{r.METRICS?.writeDataPoint?.({blobs:[c.username,"session"],doubles:[y,Date.now()-k]})}catch{}}})}async function on(e,t){if(e.user_socks5)try{if(e.user_socks5.trim().startsWith("[")){let r=JSON.parse(e.user_socks5);if(Array.isArray(r)&&r.length)return r[Math.floor(Math.random()*r.length)]}return e.user_socks5}catch{return e.user_socks5}if(e.user_proxy_iata)try{let r=t.POOL_STATE.idFromName("global"),n=t.POOL_STATE.get(r),s=e.user_proxy_iata.toUpperCase(),a=await n.fetch(`http://do/pick?cc=${encodeURIComponent(s)}`);if(a.ok)return(await a.json()).uri}catch{}return null}function cn(e){let t=(e.PROXY_FALLBACK_HOSTS||"").split(",").map(n=>n.trim()).filter(Boolean);return t.length?`${t[Math.floor(Math.random()*t.length)]}.proxyip.cmliussss.net`:null}var Fe="aether_session",zt=60*60*24*7;async function L(e,t){let r=e.env,n=e.req.header("authorization");if(n&&n.toLowerCase().startsWith("bearer ")){let o=n.slice(7).trim(),i=await Y(o),c=await r.DB.prepare("SELECT * FROM api_tokens WHERE token_hash = ? AND (expires_at IS NULL OR expires_at > ?)").bind(i,Math.floor(Date.now()/1e3)).first();if(c)return e.set("actor",`token:${c.name}`),e.set("scopes",ln(c.scopes)||[]),e.set("authKind","token"),await r.DB.prepare("UPDATE api_tokens SET last_used = ? WHERE id = ?").bind(Math.floor(Date.now()/1e3),c.id).run().catch(()=>{}),t()}let a=(e.req.header("cookie")||"").split(";").map(o=>o.trim()).find(o=>o.startsWith(Fe+"="));if(a){let o=a.split("=").slice(1).join("="),i=await Y(o),c=await r.DB.prepare(`SELECT s.*, a.username, a.role
         FROM sessions s JOIN admins a ON a.id = s.admin_id
        WHERE s.token_hash = ? AND s.expires_at > ?`).bind(i,Math.floor(Date.now()/1e3)).first();if(c)return e.set("actor",c.username),e.set("adminId",c.admin_id),e.set("role",c.role),e.set("authKind","session"),t()}return e.json({error:"unauthorized"},401)}function U(...e){return async(t,r)=>{let n=t.get("role");return t.get("authKind")==="token"?(t.get("scopes")||[]).includes("admin")?r():t.json({error:"forbidden"},403):!n||!e.includes(n)?t.json({error:"forbidden"},403):r()}}async function Kt(e,t,r){let n=crypto.randomUUID()+crypto.randomUUID(),s=await Y(n),a=e.req.header("user-agent")||"",o=e.req.header("CF-Connecting-IP")||"",i=Math.floor(Date.now()/1e3);await r.DB.prepare("INSERT INTO sessions (token_hash, admin_id, user_agent, ip, expires_at, created_at) VALUES (?,?,?,?,?,?)").bind(s,t,a,o,i+zt,i).run(),Jt(e,n,i+zt)}async function Gt(e,t){let n=(e.req.header("cookie")||"").split(";").map(s=>s.trim()).find(s=>s.startsWith(Fe+"="));if(n){let s=n.split("=").slice(1).join("="),a=await Y(s);await t.DB.prepare("DELETE FROM sessions WHERE token_hash = ?").bind(a).run().catch(()=>{})}Jt(e,"",0)}function Jt(e,t,r){let s="Lax",a=[`${Fe}=${t}`,"Path=/",`Max-Age=${r}`,"HttpOnly",s?`SameSite=${s}`:"","Secure"].filter(Boolean);e.header("Set-Cookie",a.join("; "))}function ln(e){try{return JSON.parse(e)}catch{return null}}var j=new B;j.post("/setup",async e=>{let t=e.env,r=await t.DB.prepare("SELECT COUNT(*) AS n FROM admins").first();if(r&&r.n>0)return e.json({error:"already initialized"},400);let n=await e.req.json();if(!n.username||!n.password||n.password.length<8)return e.json({error:"username and password (>=8 chars) required"},400);let s=await se(n.password);return await t.DB.prepare("INSERT INTO admins (username, password_hash, role, is_active) VALUES (?,?, 'owner', 1)").bind(n.username,s).run(),e.json({ok:!0})});j.post("/auto-bootstrap",async e=>{let t=e.env;if(!t.ADMIN_BOOTSTRAP_PASSWORD)return e.json({error:"no bootstrap secret"},400);let r=await t.DB.prepare("SELECT COUNT(*) AS n FROM admins").first();if(r&&r.n>0)return e.json({ok:!0,already:!0});let n=await se(t.ADMIN_BOOTSTRAP_PASSWORD);return await t.DB.prepare("INSERT INTO admins (username, password_hash, role, is_active) VALUES (?, ?, 'owner', 1)").bind("admin",n).run(),e.json({ok:!0})});j.post("/login",async e=>{let t=e.env,r=await e.req.json(),n=await t.DB.prepare("SELECT * FROM admins WHERE username = ? AND is_active = 1").bind(r.username).first();if(!n||!await He(r.password,n.password_hash))return e.json({error:"invalid credentials"},401);if(n.totp_secret&&(!r.totp||!await Ht(n.totp_secret,r.totp)))return e.json({error:"totp required"},401);if(!n.password_hash.startsWith("pbkdf2$")){let s=await se(r.password);await t.DB.prepare("UPDATE admins SET password_hash = ? WHERE id = ?").bind(s,n.id).run()}return await t.DB.prepare("UPDATE admins SET last_login = ? WHERE id = ?").bind(C(),n.id).run(),await Kt(e,n.id,t),e.json({ok:!0})});j.post("/logout",async e=>(await Gt(e,e.env),e.json({ok:!0})));j.get("/me",L,async e=>e.json({actor:e.get("actor"),role:e.get("role"),kind:e.get("authKind")}));j.post("/change-password",L,async e=>{let t=e.env,r=e.get("adminId");if(!r)return e.json({error:"session required"},403);let n=await e.req.json();if(!n.next||n.next.length<8)return e.json({error:"password too short"},400);let s=await t.DB.prepare("SELECT password_hash FROM admins WHERE id = ?").bind(r).first();return!s||!await He(n.current,s.password_hash)?e.json({error:"bad current password"},400):(await t.DB.prepare("UPDATE admins SET password_hash = ? WHERE id = ?").bind(await se(n.next),r).run(),e.json({ok:!0}))});j.post("/2fa/enroll",L,async e=>{let t=e.get("adminId");if(!t)return e.json({error:"session required"},403);let r=qt();await e.env.DB.prepare("UPDATE admins SET totp_secret = ? WHERE id = ?").bind(r,t).run();let n=await e.env.DB.prepare("SELECT username FROM admins WHERE id = ?").bind(t).first();return e.json({secret:r,uri:Nt(r,"Aether Panel",n.username)})});j.post("/2fa/disable",L,async e=>{let t=e.get("adminId");return t?(await e.env.DB.prepare("UPDATE admins SET totp_secret = NULL WHERE id = ?").bind(t).run(),e.json({ok:!0})):e.json({error:"session required"},403)});j.post("/token",L,async e=>{let t=await e.req.json(),r=Ne(32),n=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(r)),s=Array.from(new Uint8Array(n)).map(o=>o.toString(16).padStart(2,"0")).join(""),a=t.ttlDays?C()+t.ttlDays*86400:null;return await e.env.DB.prepare("INSERT INTO api_tokens (name, token_hash, scopes, expires_at) VALUES (?,?,?,?)").bind(t.name,s,JSON.stringify(t.scopes||["read"]),a).run(),e.json({token:r,expiresAt:a})});var O=new B;O.use("*",L);O.get("/",async e=>{let t=e.req.query("q")||"",r=Math.max(1,parseInt(e.req.query("page")||"1",10)),n=Math.min(200,parseInt(e.req.query("pageSize")||"50",10)),s=(r-1)*n,a=`%${t}%`,o=await e.env.DB.prepare("SELECT * FROM users WHERE username LIKE ? OR uuid LIKE ? ORDER BY id DESC LIMIT ? OFFSET ?").bind(a,a,n,s).all(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM users WHERE username LIKE ? OR uuid LIKE ?").bind(a,a).first();return e.json({users:o.results,total:i?.n??0,page:r,pageSize:n})});O.get("/:username",async e=>{let t=e.req.param("username"),r=await e.env.DB.prepare("SELECT * FROM users WHERE username = ? COLLATE NOCASE").bind(t).first();return r?e.json(r):e.json({error:"not found"},404)});O.post("/",U("owner","admin"),async e=>{let t=await e.req.json();if(!t.username)return e.json({error:"username required"},400);let r=t.uuid||De(),n=await ne(r),s=C();try{await e.env.DB.prepare(`INSERT INTO users (
...
\u{1F517} `+i.panel+`
\u{1F464} `+(i.adminUser||"admin")+`
\u{1F511} <code>`+M(i.admin||"\u2014")+"</code>",D):await R(t,r,e.message.message_id,"\u0627\u06CC\u0646 \u062D\u0633\u0627\u0628 \u0647\u0646\u0648\u0632 \u067E\u0646\u0644\u06CC \u0646\u0633\u0627\u062E\u062A\u0647 \u0627\u0633\u062A.",Z()),new Response("ok");if(a==="list")return await q(t,e.id),await yn(t,r,e.message.message_id,i),new Response("ok")}return await q(t,e.id),new Response("ok")}async function gn(e,t,r,n){if(n==="home"){await R(e,t,r,`\u{1F3E0} <b>\u0645\u0646\u0648\u06CC \u0627\u0635\u0644\u06CC</b>
...
<\/script></body></html>`}function dr(e,t=!1){return`<!doctype html>
...
`:"")+`  - GEOIP,IR,DIRECT
  - MATCH,PROXY
`}function kn(e,t,r){let n=e.sni_host||t.host,s=Ee(e.ips)[0]||oe[0];return{log:{level:"info"},dns:{servers:[{tag:"cf",address:"https://cloudflare-dns.com/dns-query"},{tag:"local",address:"local",detour:"direct"}],rules:[{domain_suffix:[".ir"],server:"local"}]},outbounds:[{type:"vless",tag:"proxy",server:s,server_port:e.port||443,uuid:e.uuid,tls:{enabled:!0,server_name:n,utls:{enabled:!0,fingerprint:e.fingerprint||"chrome"}},transport:{type:"ws",path:"/"}},{type:"direct",tag:"direct"},{type:"block",tag:"block"}],route:{final:"proxy"}}}function pr(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(r=>typeof r=="string"):[]}catch{return[]}}function hr(e){let t=new TextEncoder().encode(e),r="";for(let n=0;n<t.byteLength;n++)r+=String.fromCharCode(t[n]);return btoa(r)}var _n={bytesUnflushed:0,requestsUnflushed:0,lastFlush:0,active:{}},An=25*1024*1024,Sn=3e4,Ge=class{state;env;data={..._n};flushTimer=null;constructor(t,r){this.state=t,this.env=r,this.state.blockConcurrencyWhile(async()=>{let n=await this.state.storage.get("data");n&&(this.data=n)}),this.flushTimer=setInterval(()=>{this.state.waitUntil(this.flush())},Sn)}async fetch(t){let r=new URL(t.url);switch(r.pathname.replace(/^\//,"")){case"connect":{let{ip:s,subnet:a,ua:o}=await t.json(),i=parseInt(r.searchParams.get("ipLimit")||"0",10),c=Object.keys(this.data.active);return i>0&&c.length>=i&&!this.data.active[a]?Response.json({ok:!1,code:"ip_limit",active:c.length}):(this.data.active[a]={ip:s,subnet:a,ua:o,startedAt:Date.now()},await this.persist(),Response.json({ok:!0,active:Object.keys(this.data.active).length}))}case"disconnect":{let{subnet:s}=await t.json();return delete this.data.active[s],await this.persist(),Response.json({ok:!0,active:Object.keys(this.data.active).length})}case"addBytes":{let{bytes:s,requests:a}=await t.json();return this.data.bytesUnflushed+=s|0,this.data.requestsUnflushed+=(a||0)|0,this.data.bytesUnflushed>=An&&this.state.waitUntil(this.flush()),Response.json({ok:!0,unflushed:this.data.bytesUnflushed})}case"status":return Response.json({active:Object.keys(this.data.active).length,unflushedBytes:this.data.bytesUnflushed,unflushedRequests:this.data.requestsUnflushed,connections:this.data.active});case"flush":return await this.flush(),Response.json({ok:!0});default:return new Response("not found",{status:404})}}async persist(){await this.state.storage.put("data",this.data)}async flush(){if(this.data.bytesUnflushed===0&&this.data.requestsUnflushed===0)return;let t=this.data.bytesUnflushed,r=this.data.requestsUnflushed;this.data.bytesUnflushed=0,this.data.requestsUnflushed=0,this.data.lastFlush=Date.now(),await this.persist();try{let n=this.state.id.name?.toString()||"";if(n){let s=t/1073741824;await this.env.DB.prepare(`UPDATE users
             SET used_gb = used_gb + ?,
                 lifetime_gb = lifetime_gb + ?,
                 used_req = used_req + ?,
                 last_active = ?
           WHERE username = ?`).bind(s,s,r,Math.floor(Date.now()/1e3),n).run()}}catch(n){this.data.bytesUnflushed+=t,this.data.requestsUnflushed+=r,await this.persist(),console.error("UserState flush failed",n)}}};var Rn={byCountry:{}},Je=class{state;env;data=Rn;alarmScheduled=!1;constructor(t,r){this.state=t,this.env=r,this.state.blockConcurrencyWhile(async()=>{let n=await this.state.storage.get("pool");n&&(this.data=n)})}async fetch(t){let r=new URL(t.url),n=r.pathname.replace(/^\//,"");if(n==="pick"){let s=(r.searchParams.get("cc")||"").toUpperCase(),o=(s?this.data.byCountry[s]||[]:Object.values(this.data.byCountry).flat()).filter(c=>c.ok);if(!o.length)return Response.json({error:"empty pool"},{status:503});let i=o[Math.floor(Math.random()*o.length)];return Response.json({uri:i.uri,latencyMs:i.latencyMs,country:i.country})}if(n==="import"){let{country:s,list:a}=await t.json(),o=(s||"XX").toUpperCase();return this.data.byCountry[o]=a.map(i=>({uri:i,country:o,ok:!0,lastChecked:0})),await this.state.storage.put("pool",this.data),this.scheduleAlarm(),Response.json({ok:!0,count:a.length})}return n==="health-check"?(Tn(this.state,this.healthCheck()),Response.json({ok:!0})):new Response("not found",{status:404})}scheduleAlarm(){this.alarmScheduled||(this.alarmScheduled=!0,this.state.storage.setAlarm(6e4).catch(()=>{}))}async alarm(){this.alarmScheduled=!1,await this.healthCheck(),Object.values(this.data.byCountry).flat().length&&this.scheduleAlarm()}async healthCheck(){let r=Object.values(this.data.byCountry).flat().slice(0,50);for(let n of r){try{let s=new URL(n.uri),a=s.hostname,o=parseInt(s.port||"1080",10),i=Date.now(),c=new AbortController,l=setTimeout(()=>c.abort(),4e3),d=await fetch(`https://${a}:${o}`,{method:"HEAD",signal:c.signal,mode:"no-cors"}).catch(()=>null);clearTimeout(l),n.latencyMs=Date.now()-i,n.ok=!!d}catch{n.ok=!1}n.lastChecked=Date.now()}for(let n of Object.keys(this.data.byCountry))this.data.byCountry[n]=this.data.byCountry[n].filter(s=>s.ok);await this.state.storage.put("pool",this.data)}};function Tn(e,t){try{e.waitUntil(t)}catch{}}var Ye=class{state;env;bucket={count:0,resetAt:0};constructor(t,r){this.state=t,this.env=r,this.state.blockConcurrencyWhile(async()=>{let n=await this.state.storage.get("b");n&&(this.bucket=n)})}async fetch(t){let r=new URL(t.url),n=parseInt(r.searchParams.get("limit")||"5",10),s=parseInt(r.searchParams.get("window")||"900000",10),a=Date.now();return a>this.bucket.resetAt&&(this.bucket={count:0,resetAt:a+s}),this.bucket.count+=1,await this.state.storage.put("b",this.bucket),Response.json({ok:this.bucket.count<=n,count:this.bucket.count,remaining:Math.max(0,n-this.bucket.count),resetAt:this.bucket.resetAt})}};var mr=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
...
</svg>`,fr=JSON.stringify({name:"Aether Panel",short_name:"Aether",description:"Modern Cloudflare Worker proxy panel",start_url:"/panel",scope:"/",display:"standalone",background_color:"#07090d",theme_color:"#07090d",dir:"rtl",lang:"fa-IR",orientation:"any",icons:[{src:"/icon.svg",sizes:"192x192 512x512",type:"image/svg+xml",purpose:"any maskable"}],categories:["utilities","productivity"]}),gr=`
...
`).map(u=>u.trim()).filter(Boolean),l="unknown",d=[];for(let u of c)u.startsWith("#")?l=u.slice(1).trim():u.startsWith("[")||d.push(u);d.length&&(o[l]=d)}for(let i of r){let c=i.ip_operator==="all"?Object.values(o).flat():o[String(i.ip_operator||"all")]||[];if(!c.length)continue;let l=Number(i.ip_count)||15,d=[];for(let u=0;u<l&&c.length;u++)d.push(c[Math.floor(Math.random()*c.length)]);await e.DB.prepare("UPDATE users SET ips = ?, last_rotate_time = ? WHERE id = ?").bind(JSON.stringify(d),t,i.id).run()}}catch(t){console.error("autoRotateIps",t)}}var br=!1;async function Bn(e){if(!br){br=!0;try{let t=await e.DB.prepare("SELECT COUNT(*) AS n FROM proxies").first();t&&t.n>0&&await Q(e)}catch(t){console.error("ensurePoolSynced",t)}}}async function jn(e){let t=Date.now(),r=Math.floor(t/864e5)*864e5;await e.DB.prepare(`UPDATE users SET used_gb = 0, is_active = 1, last_reset_vol_time = ?
      ...
      WHERE auto_reset_req_days > 0 AND ? >= (last_reset_req_time + auto_reset_req_days * 86400000)`).bind(r,r).run()}var xo={fetch:Un,scheduled:Cn,queue:Pn};export{Je as PoolState,Ye as RateLimiter,Ge as UserState,xo as default};
